...
<!-- Mirrored from ex-coders.com/html/xports/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 May 2026 15:35:30 GMT -->
<head>
       <!-- ========== Meta Tags ========== -->
        <meta charset="UTF-8">
    ...
    <body>
                                        ...
                                        <ul>
                                                        ...
                                                        <div class="homemenu-items">
                                                            ...
                                                            <div class="homemenu">
                                                                <div class="homemenu-thumb mb-15">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-6.html" class="gt-theme-btn">
                                                                            Multi Page
                                                                        </a>
                                                                    </div>
                                                                </div>
                                            ...
                                            <li class="has-dropdown active d-xl-none">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="index-4.html">Gaming Studio</a></li>
                                                    <li><a href="index-5.html">Gamer</a></li>
                                                    <li><a href="index-6.html">Gaming News</a></li>
                                                </ul>
                                            </li>
                                            <li>
            ...
            <div class="modal-dialog style-shop-details modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="gt-shop-details-left-item">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="#thumb4" data-bs-toggle="tab" class="nav-link ps-0">
                                                <img src="assets/img/inner-page/shop-details/product-1.jpg" alt="img">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#thumb5" data-bs-toggle="tab" class="nav-link active">
                                                <img src="assets/img/inner-page/shop-details/product-2.jpg" alt="img">
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content">
                                        <div id="thumb4" class="tab-pane fade">
                                            <div class="shop-thumb">
                                                <img src="assets/img/inner-page/shop-details/product-4.jpg" alt="img">
                                            </div>
                                        </div>
                                        <div id="thumb5" class="tab-pane fade show active">
                                            <div class="shop-thumb">
                                                <img src="assets/img/inner-page/shop-details/product-4.jpg" alt="img">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="gt-shop-details-content">
                                    ...
                                    <div class="gt-price-item">
                                        <h6>
                                            regular price <span>: $120.99</span>
                                        </h6>
                                        <h6 class="gt-bg">
                                            discount price <span class="gt-color">: $99.99</span>
                                        </h6>
                                        <h6>
                                            Product Code : 18396
                                        </h6>
                                    ...
                                    <div class="gt-color-list">
                                        <h6>
                                            select color :
                                        </h6>
                                        <ul class="gt-list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="swatch-value gt-bg-color"></span>
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="swatch-value gt-bg-color-2"></span>
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="swatch-value gt-bg-color-3"></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="gt-button-wrapper">
                                        ...
                                        <a href="shop-details-2.html" class="gt-theme-btn">
                                            add to cart
                                        </a>
                                        <a href="shop-details-2.html" class="gt-theme-btn gt-style-border style-2">
                                            buy now
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="gt-page-heading">
                    <div class="gt-breadcrumb-sub-title">
                        <h1 class="wow fadeInUp" data-wow-delay=".3s">our shop</h1>
                    </div>
       ...
       <section class="gt-shop-section section-padding fix">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="gt-shop-card-item gt-style-2 mt-0">
                        <span>25% off</span>
                        <div class="gt-shop-image">
                            <img src="assets/img/home-1/shop/shop-1.png" alt="img">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="gt-shop-card-item gt-style-2 mt-0">
                        <span>25% off</span>
                        <div class="gt-shop-image">
                            <img src="assets/img/home-1/shop/shop-2.png" alt="img">
                            <ul class="gt-shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="gt-shop-card-item gt-style-2 mt-0">
                        <span>25% off</span>
                        <div class="gt-shop-image">
                            <img src="assets/img/home-1/shop/shop-3.png" alt="img">
                            <ul class="gt-shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="gt-shop-card-item gt-style-2 mt-0">
                        <span>25% off</span>
                        <div class="gt-shop-image">
                            <img src="assets/img/home-1/shop/shop-4.png" alt="img">
                            <ul class="gt-shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                ...
                <div class="col-xl-12">
                    <div class="shop-bg-image bg-cover" style="background-image: url(assets/img/home-1/shop/shop-bg-2.jpg);">
                        <div class="ride-man">
                            <img src="assets/img/home-1/shop/ride-man.png" alt="img">
                        </div>
                        <div class="shop-bg-content">
                            <h5>
                                Xports live steam
                            </h5>
                            <h2>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="gt-shop-card-item gt-style-2 mt-0">
                        <span>25% off</span>
                        <div class="gt-shop-image">
                            <img src="assets/img/home-1/shop/shop-9.png" alt="img">
                            <ul class="gt-shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
            ...
            <div class="gt-page-nav-wrap pt-5 text-center">
                <ul>
                    <li><a class="gt-page-numbers" href="#"><i class="fa-solid fa-chevron-left"></i></a></li>
                    <li><a class="gt-page-numbers" href="#">01</a></li>
                    <li><a class="gt-page-numbers active" href="#">02</a></li>
                    <li><a class="gt-page-numbers" href="#">03</a></li>
                    <li><a class="gt-page-numbers" href="#">04</a></li>
                    <li><a class="gt-page-numbers" href="#"><i class="fa-solid fa-chevron-right"></i></a></li>
                </ul>
            </div>
        </div>
       </section>
        ...
        <section class="gt-newsletter-section fix mb-4">
            <div class="container">
                <div class="gt-newsletter-wrapper bg-cover" style="background-image: url(assets/img/home-1/cta/newsletter-bg.jpg);">
                    <div class="shape">
                    ...
                    <form action="#" class="wow fadeInRight" data-wow-delay=".5s">
                        <div class="form-clt">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".2s">
                            <div class="gt-footer-widget-items">
                                <div class="gt-widget-head">
                                    <a href="index-2.html" class="gt-footer-logo">
...
<!-- Mirrored from ex-coders.com/html/xports/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 May 2026 15:35:32 GMT -->
</html>