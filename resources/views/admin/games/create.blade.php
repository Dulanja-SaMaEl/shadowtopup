<x-admin-layout>
    <div class="mb-10">
        ...
        <h2 class="text-3xl font-black text-white uppercase tracking-tight">Add New Game</h2>
        <p class="text-gray-400 text-sm mt-1">Configure a new game title, category, and banner media.</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Free Fire, Mobile Legends" required class="w-full bg-white/5 border-white/10 rounded-xl py-3 px-4 text-sm text-white placeholder-gray-500 focus:ring-purple-500 focus:border-purple-500 transition shadow-inner">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="e.g. Battle Royale, MOBA" class="w-full bg-white/5 border-white/10 rounded-xl py-3 px-4 text-sm text-white placeholder-gray-500 focus:ring-purple-500 focus:border-purple-500 transition shadow-inner">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Brief description for customer storefront..." class="w-full bg-white/5 border-white/10 rounded-xl py-3 px-4 text-sm text-white placeholder-gray-500 focus:ring-purple-500 focus:border-purple-500 transition shadow-inner">{{ old('description') }}</textarea>
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Game Logo (Square Image)</label>
                        ...
                        <div class="relative group h-40 w-full">
                            ...
                            <label for="banner" class="w-full h-full border-2 border-dashed border-white/10 hover:border-purple-500/50 rounded-2xl flex flex-col items-center justify-center cursor-pointer transition bg-white/5 overflow-hidden">
                                ...
                                <div id="banner-placeholder" class="text-center p-4">
                                    ...
                                    <span class="text-[10px] text-gray-300 font-bold uppercase tracking-wider block">Upload Header Banner</span>
                                </div>
                            </label>
                        </div>
                    </div>
