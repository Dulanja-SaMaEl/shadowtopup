...
const homepageFaqs = [
  {
    question: 'What is ShadowTopUp?',
    answer:
      'ShadowTopUp is an independent third-party gaming top-up platform based in Sri Lanka, providing instant Free Fire diamond recharges, memberships, and wholesale reseller solutions.',
  },
  {
    question: 'How fast are Free Fire top-ups delivered?',
    answer:
      'Orders are processed through an automated dispatch engine and delivered to your Free Fire account in under 30 seconds after payment confirmation.',
  },
  {
    question: 'How do I verify my Free Fire Player ID?',
    answer:
      'Simply type your numeric Player UID into our verification box. Our system looks up your live in-game nickname to verify your account before you complete the order.',
  },
  {
    question: 'What payment options do you support in Sri Lanka?',
    answer:
      'We accept Dialog eZ Cash automated SMS payment verification, Sri Lankan bank transfers, and prepaid Shadow Wallet balances.',
  },
  {
    question: 'How do I join the wholesale reseller program?',
    answer:
      'Create an account, deposit into your Shadow Wallet, and apply for a reseller tier (Silver 8% off, Gold 15% off) to start reselling gaming top-ups at profit.',
  },
];

export const metadata: Metadata = {
  title: 'Free Fire Diamonds Sri Lanka | ShadowTopUp',
  description:
    'Instant Free Fire SG/MY diamonds and passes in Sri Lanka. Automated Player UID verification, low LKR rates, Dialog eZ Cash, and wholesale reseller discounts.',
  alternates: {
  ...
  openGraph: {
    title: 'Free Fire Diamonds Sri Lanka | ShadowTopUp',
    description:
      'Instant Free Fire SG/MY diamonds and passes in Sri Lanka. Automated Player UID verification, low LKR rates, and reseller discounts.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${SITE_NAME} - Instant Free Fire Diamonds Sri Lanka`,
      },
    ],
  },
  twitter: {
    ...
    title: 'Free Fire Diamonds Sri Lanka | ShadowTopUp',
    description:
      'Instant Free Fire SG/MY diamonds and passes in Sri Lanka with automated player UID verification.',
    ...
    <>
      ...
      <div className="space-y-20 pb-16">
        ...
        <div className="bg-amber-500/10 border-b border-amber-500/20 py-2 px-4 text-center text-[11px] font-mono text-amber-300 flex items-center justify-center gap-2">
          ...
          <span>
            ShadowTopUp is an independent third-party service and is not affiliated with or endorsed by Garena.
          </span>
        </div>
        ...
        <section className="max-w-6xl mx-auto px-4 space-y-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-800/80 pb-6">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-wide mt-1">
                SUPPORTED GAMES
              </h2>
            </div>
            ...
            {games.map((game, idx) => (
              <div
                ...
                className={`p-6 rounded-3xl bg-[#141229] border transition-all flex flex-col justify-between space-y-6 ${
                  game.available
                    ? 'border-purple-500/50 hover:border-cyan-400 shadow-2xl hover:shadow-cyan-500/10'
              ...
              >
                <div className="space-y-4">
                  <div className="relative h-48 rounded-2xl overflow-hidden bg-slate-950 border border-slate-800">
                    <img
                      src={game.image}
                      alt={`${game.title} Top Up Sri Lanka`}
        ...
        <section id="reseller-tiers" className="max-w-6xl mx-auto px-4 space-y-8">
          ...
          <div className="text-center pt-2">
            <Link
              href="/reseller"
              className="inline-flex items-center gap-2 text-xs font-mono font-bold text-amber-400 hover:text-amber-300 transition-colors uppercase tracking-wider"
            >
              Explore Reseller Program Details &rarr;
            </Link>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-4 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400 max-w-xl mx-auto">
              Got questions about Free Fire diamonds, UID safety, or Sri Lanka payment methods? We have answers.
            </p>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-4">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-purple-950/60 via-[#141229] to-cyan-950/60 border border-purple-900/40 text-center space-y-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="pt-4 flex flex-col sm:flex-row justify-center gap-3">
              <Link
                href="/games/free-fire"
                className="inline-block px-10 py-4 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white font-black text-xs uppercase tracking-widest shadow-xl shadow-purple-600/40 transition-all hover:scale-105 text-center"
              >
                RECHARGE FREE FIRE NOW
              </Link>
              <Link
                href="/how-it-works"
                className="inline-block px-8 py-4 rounded-2xl bg-[#141229] border border-purple-900/60 hover:bg-purple-950/40 text-purple-300 font-extrabold text-xs uppercase tracking-widest transition-all text-center"
              >
                HOW IT WORKS
              </Link>
            </div>
